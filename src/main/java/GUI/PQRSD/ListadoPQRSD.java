...
public class ListadoPQRSD extends javax.swing.JFrame {
    ...
    public ListadoPQRSD() {
        ...
        try {
            ...
            PreparedStatement ps = c.establecerConexion().prepareStatement(query);
    ...
    public void ActualizarTabla(){
        try{
            ...
            String refresh = "EXEC sp_ListadoPQRSD";
                    PreparedStatement ps = c.establecerConexion().prepareStatement(refresh);
                    ResultSetMetaData meta = ps.getMetaData();
    ...
    private void initComponents() {
        ...
        btnComentario.setBackground(new java.awt.Color(204, 204, 255));
        btnComentario.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnComentario.setText("Agregar comentario");
        btnComentario.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        DescargarArchivos.setBackground(new java.awt.Color(204, 204, 204));
        DescargarArchivos.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        DescargarArchivos.setText("Descargar Adjuntos");
        DescargarArchivos.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        btnResponder.setBackground(new java.awt.Color(204, 204, 204));
        ...
        btnFormulario.setBackground(new java.awt.Color(51, 153, 0));
        ...
        btnFormulario.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        if (IDPQRSD > 0) {
            ...
            if (IDArchivo == 0) {
                ...
                try {
                    ...
                    ResultSet rs = c.establecerConexion().createStatement().executeQuery(query);
    ...
    private void btnAdjuntarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdjuntarActionPerformed
        ...
        try {
            if (result == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    PreparedStatement pst = c.establecerConexion().prepareStatement("INSERT INTO tblArchivosRespuesta VALUES(?)");
